...
# Stopwords
stopwords = {'men',  'mening', 'o\'zim', 'biz', 'o\'zimizniki',  'siz', 'sening', 'seniki', 'o\'zing',
             'u',  'uning', 'o\'zi', 'u', 'uning',
             "ular",  "ularning", "o'zlari", "nima", "qaysi", "kim", "bu",
             "bular", "men", "bor", "bor",  "bo'lgan",
              'va', 'agar', 'yoki', 'chunki', 'hozirda',
              'bilan', 'haqida', 'qarshi', 'orasida', 'ichiga', 'orqali', 'davrida', 'oldin',
             'keyin', 'yuqorida', 'pastda',  'yuqoriga', 'pastga', 'kirish', 'tashqariga', 'yoqish',  'ustun', 'pastda' , 'yana',
             "keyingi", "keyin", "bir marta", "bu erda", "u erda", "u yerda","qachon", "qayerda", "nima uchun", "qanday", "barchasi", "har qanday", "ikkovi", "har biri" ,
             "oz", "ko'proq", "ko'p", "boshqa", "ba'zi", "bunday", "yo'q", "faqat", "o'z", "bir xil", "har xil", "xilma-xil" "shunday",
             'juda',  'mumkin', 'bo\'ladi', 'shunchaki', 'kerak', 'hozir'}
...
def fd2(counts):
    """Given a list of 2-uplets (e.g., [(a,pos), (a,pos), (a,neg), ...]), form a dict of frequencies of specific
    items (e.g., {a:{pos:2, neg:1}, ...}). """
    d = {}
    for i in counts:
...
class BaselineStageII():
    ...
    def tag(self, test_instances):
        ...
        for i in test_instances:
            ...
            for j in i_.aspect_categories:
                j.polarity = self.b4.majority(i_.text)
            clones.append(i_)
        return clones
